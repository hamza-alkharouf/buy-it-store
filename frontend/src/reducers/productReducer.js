...
export const WomenAndMenProductsReducer = (state = { products: [] }, action) => {
  switch (action.type) {
    case WOMEN_AND_MEN_PRODUCT_REQUEST:
      return {
        loading: true,
        products: [],
      };
    case WOMEN_AND_MEN_PRODUCT_SUCCESS:
      return {
        loading: false,
        products: action.payload.products,
        productsCount: action.payload.productsCount,
    ...
    case WOMEN_AND_MEN_PRODUCT_FAIL:
      return {
        loading: false,
        error: action.payload,
      };
...
export const newAddProductsReducer = (state = { products: [] }, action) => {
  switch (action.type) {
