...
const CategoryDetails = ({ match }) => {
  ...
  const [category, setCategory] = useState(match.params.id);
  ...
  const { categoryy, loadingCategory, errorCategory } = useSelector(
  ...
  }, [dispatch, keyword, currentPage, price, category, forwhom, ratings, alert, error,errorCategory]);
    ...
    <Fragment>
      {loading && loadingCategory? (
        ...
        <Fragment>
          ...
          <h2 className="productsHeading">{match.params.category}</h2>
